...
video_path = r"C:\Users\ksost\soccer_env\cliped_data\video\highlights"
video_dataset = prepare_dataset_video(video_path)
video_data_loader = DataLoader(video_dataset, batch_size=4, shuffle=False, collate_fn=collate_fn_video)
...
for data in video_data_loader:
    ...
    print(i)
    print(cliped_data.logits.shape)
    i += 1
